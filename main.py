...
y_ref, t_ref, _, name_train = createObservations(forecast_model, TA_params={'law': law_train,
                                                                   'dt': dt_train,
                                                                   'beta': beta_train,
                                                                   'tau': tau_train},
...
# plt.subplots(2, 1)
# plt.subplot(2, 1, 1)
# plt.plot(t_true, y_true[:, 0], label=name_truth)
# plt.plot(t_ref, y_ref[:, 0], alpha=0.5, label=name_train)
# plt.legend()
# plt.subplot(2, 1, 2)
# plt.plot(t_ref, biasData[:, 0], 'firebrick')
# plt.show()
...
model_params = {'law': law_train,
                'dt': dt_train,                 # Dictionary of TA parameters
                'beta': beta_train * 1.,
                'tau': tau_train * 1.
                }
...
if save_:
    filename = 'results/' + str(date.today()) + '_Bias_' + bias_name
